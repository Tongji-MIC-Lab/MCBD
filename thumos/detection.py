...
def _gen_detection_video(video_name, video_cls, thu_label_id, opt, num_prop=200, topk = 2):
    ...
    for snippet_file in files:
        ...
        snippet_df['score'] = snippet_df.start.values[:] * snippet_df.end.values[:] * snippet_df.iou_clr.values[:]*snippet_df.iou_reg.values[:]
...
if __name__ == '__main__':
    ...
    print("Detection post processing start, nms_thr "+str(opt['nms_thr']))
    ...
    print("average mAP is {}".format(average_mAP))
